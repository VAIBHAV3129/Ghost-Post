...
By utilizing the Raspberry Pi Pico 2W (RP2350), Ghost Post creates a local WiFi captive portal, I believe it will serve a highly useful purpose and also act as an excellent solution for environments where privacy is very often compromised of the connectivity is non existent.
